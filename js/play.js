...
var playState = {
  ...
  create: function () {
    ...
    if (rand == 5) {
      this.newBullet = game.add.group();
      back_layer.add(this.newBullet);
      this.newBullet.enableBody = true;
      this.newBullet.physicsBodyType = Phaser.Physics.ARCADE;
      var mx = game.width - game.cache.getImage('newBullet').width * 100;
      var my = game.height - game.cache.getImage('newBullet').height * 100;
      ...
      this.newBullet.create(hXaxis, hYaxis, 'newBullet');
    }
  ...
  update: function () {
    ...
    */
    ...
    game.physics.arcade.overlap(this.newBullet, this.player, function (p, h) {
      h.kill();
      this.handgun = game.add.weapon(7, 'newBullet');
